        ...
        <ul class="nav" id="main-menu">
			...
			foreach ($result_top_menu as $top_menu):
				...
				<li>
					...
					<?php
						//Select all Childs
					 if($top_menu['menu_name']!='appointments' or $level!='Doctor'){
						...
						if($rowcount != 0){?>
							<ul class="nav nav-second-level">
								...
								foreach ($result_sub_menu as $sub_menu){
									...
									if($this->menu_model->has_access($sub_menu['menu_name'],$level) or $sub_menu['parent_name']=='appointments'){
			...
			<!--
			<li>
				<a target="_blank" title="<?php echo $this->lang->line('cmp_name');?>" href="http://sanskrutitech.in"><?php echo $this->lang->line('copyright');?> <?php echo $this->lang->line('cmp_name');?></a>
