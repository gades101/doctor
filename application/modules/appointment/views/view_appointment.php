<?php
	...
	if(!isset($treatment_total))$treatment_total=0;
		...
		<div class="col-md-12">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<div class="col-md-12">
						<div class="col-md-4">
							<div class="form-group">
								<label><?= $this->lang->line('patient');?>:</label>
					...
					<div class="col-md-12">
						<div class="col-md-12">
							<label>Деталі Рахунка</label>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<label>ID Рахунка:</label>
								<span><?=$bill['bill_id'];?></span>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<label>Дата Рахунка:</label>
						...
						<div class="col-md-12">
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover" id="bill_table">
									<thead>
										<tr>
											<th><span style="color:black;">Докладний</span></th>
											<th>Кількість</th>
											<th>M.R.P.</th>
											<th>Обсяг</th>
										</tr>
