	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="form-group">
				...
				<a class="btn btn-primary" href="<?php echo base_url() . '/index.php/patient/edit/' . $patient_id ?> "><?php echo $this->lang->line("edit")." ".$this->lang->line("patient")."а";?></a>
			</div>
			<?php
			$followup=$followup_date;
			if ($followup!="0000-00-00"){
				$follow_up = date($def_dateformate, strtotime($followup));
			}else{
				$follow_up ="";
			}
			?>
			...
			<div class="form-group">
				<label for="doctor_name"><?php echo $this->lang->line("doctor");?></label>
				<input readonly='readonly' type="text" name="doctor_name" id="doctor_name" class="form-control" value="<?php echo $user['name']; ?>"/>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="followup_date"><?php echo $this->lang->line("date")." ".$this->lang->line("follow_up");?></label>
				<input type="text" name="followup_date" id="followup_date" class="form-control" value="<?php echo $follow_up; ?>"/>
			</div>
			<div class="form-group">
