		...
		<div class="col-md-12">
			...
			<div class="form-group">
				...
				<select name="type" class="form-control">
					<option <?php if ($visit['type'] == "Новий Візит") {echo 'selected = "selected"';} ?> value="Новий Візит"><?php echo $this->lang->line('new')." ".$this->lang->line('visit');?></option>
					<option <?php if ($visit['type'] == "Established Patient") {echo 'selected = "selected"';} ?> value="Закріплений Пацієнт"><?php echo $this->lang->line('established_patient');?></option>
				</select>
