				...
				<div class="panel-body">
					...
					<div class="col-md-8">
						<div class="form-group">
							...
							<?php } ?>
							<a href="<?= site_url("settings/remove_clinic_logo"); ?>" class="btn btn-sm square-btn-adjust btn-danger" >Видалити логотип</a>
					...
					<div class="col-md-4">
						<div class="form-group">
							<label for="start_time"><?php echo $this->lang->line('start_time')." роботи";?></label>
					...
					<div class="col-md-4">
						<div class="form-group">
							<label for="end_time"><?php echo $this->lang->line('end_time')." роботи";?></label>
					...
					<div class="col-md-12">
						<div class="form-group">
							...
							<span>Встановіть базову кількість днів між двома прийомами. Встановіть його в 0, щоб відключити автоматичну настройку наступного відвідування.</span>
